...
function toggleemailform(){
    var passwordform= document.getElementById("email-form")
...
function toggleaddressform(){
    var passwordform= document.getElementById("address-form")
...
function toggleidentityform(){
    var passwordform= document.getElementById("identity-form")
